param(
    [string]$Artifact = '<AUDIT_ROOT>\kaleidoscope-cookery-chopping-board-fix-20260814\compatible-build2-kaleidoscopecookery-1.4.1.7-migration.3-neoforge+mc1.21.1.jar',
