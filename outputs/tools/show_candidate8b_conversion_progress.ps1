...
$taskName = 'Codex-Candidate8b-WorldConversion-20260811'
$reports = 'D:\Trans\migration-audit-work\cutover-staging-candidate8b-20260811-reports'
...
$Host.UI.RawUI.WindowTitle = 'Candidate8b world conversion progress (18 workers)'
Write-Host 'Candidate8b world conversion' -ForegroundColor Cyan
Write-Host '18 region workers; 6 logical threads reserved for Windows/Codex.'
