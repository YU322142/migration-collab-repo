param(
    ...
    [string] $ReleaseRoot = 'D:\Trans\migration-audit-work\final-mod-bundles-candidate14-20260812',
    [string] $OutputRoot = '',
    [string] $Report = '',
...
$expectedRelease = 'D:\Trans\migration-audit-work\final-mod-bundles-candidate14-20260812'
