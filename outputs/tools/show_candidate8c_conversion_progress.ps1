...
$taskName = 'Codex-Candidate8c-WorldConversion-20260811'
$reports = 'D:\Trans\migration-audit-work\cutover-staging-candidate8c-20260811-reports'
...
$Host.UI.RawUI.WindowTitle = 'Candidate8c world conversion progress (12 workers)'
Write-Host 'Candidate8c world conversion' -ForegroundColor Cyan
Write-Host '12 region workers; balanced against 27.6 GB physical memory.'
