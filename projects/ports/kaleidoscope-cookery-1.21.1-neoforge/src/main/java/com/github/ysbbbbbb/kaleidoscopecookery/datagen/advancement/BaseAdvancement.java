...
public class BaseAdvancement {
    public static void generate(Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
        ...
        AdvancementHolder darkCuisine = makeTask(FoodBiteRegistry.getItem(FoodBiteRegistry.SUSPICIOUS_STIR_FRY), "dark_cuisine")
                .parent(stirFry)
        ...
        // 饭袋成就，独立的
        AdvancementHolder lunchBag = makeGoal(ModItems.TRANSMUTATION_LUNCH_BAG.get(), "transmutation_lunch_bag")
                .parent(root)
        ...
        // 石磨、蒸笼系列成就
        AdvancementHolder millstone = makeTask(ModItems.MILLSTONE.get(), "millstone")
                .parent(root)
        ...
        AdvancementHolder steamer = makeTask(ModItems.STEAMER.get(), "steamer")
                .parent(dough)
        ...
        AdvancementHolder baozi = makeGoal(ModItems.BAOZI.get(), "baozi")
                .parent(steamer)
