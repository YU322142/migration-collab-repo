...
public class ModCreativeTabs {
    ...
    public static Supplier<CreativeModeTab> COOKERY_MAIN_TAB = TABS.register("cookery_main", () -> CreativeModeTab.builder()
            ...
            .displayItems((par, output) -> {
                ...
                output.accept(ModItems.COPPER_KITCHEN_KNIFE.get());
                ...
                output.accept(ModItems.COOK_STOOL_PALE_OAK.get());
                ...
                output.accept(ModItems.CHAIR_PALE_OAK.get());
                ...
                output.accept(ModItems.TABLE_PALE_OAK.get());
