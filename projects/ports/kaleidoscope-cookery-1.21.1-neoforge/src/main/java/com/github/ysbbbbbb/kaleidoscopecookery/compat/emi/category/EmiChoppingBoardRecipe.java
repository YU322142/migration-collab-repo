...
public class EmiChoppingBoardRecipe extends BasicEmiRecipe {
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(
            ResourceLocation.parse(ModRecipes.CHOPPING_BOARD_RECIPE.toString()),
            EmiIngredient.of(Ingredient.of(ModItems.CHOPPING_BOARD.get()))
    );
    ...
    public EmiChoppingBoardRecipe(ResourceLocation id, List<EmiIngredient> inputs, List<EmiStack> outputs) {
    ...
    public static void register(EmiRegistry registry) {
        ...
        registry.addWorkstation(CATEGORY, EmiStack.of(ModItems.CHOPPING_BOARD.get()));
