...
public class PressingTubScenes {
    ...
    public static void pressing(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world().modifyEntity(slime, (e) -> {
            e.lerpTo(e.getX(), e.getY(), e.getZ(), 0, 0, 6);
        });
        scene.idle(6);
        ...
        scene.world().modifyEntity(slime, (e) -> {
            e.lerpTo(e.getX(), e.getY(), e.getZ(), 180, 0, 6);
        });
        scene.idle(6);
        ...
        scene.world().modifyEntity(slime, (e) -> {
            e.lerpTo(e.getX(), e.getY(), e.getZ(), 150, 15, 6);
        });
    ...
    public static void variant(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(1);
        scene.world().modifyEntity(slime, (e) -> e.lerpTo(e.getX(), e.getY(), e.getZ(), 180, 0, 6));
        scene.idle(6);
        speed.set(0D);
        ...
        scene.idle(1);
        scene.world().modifyEntity(slime, (e) -> e.lerpTo(e.getX(), e.getY(), e.getZ(), 0, 0, 6));
        scene.idle(6);
        scene.idle(20);
