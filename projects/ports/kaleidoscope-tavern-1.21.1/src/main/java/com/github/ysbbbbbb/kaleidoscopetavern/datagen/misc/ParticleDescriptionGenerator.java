...
public class ParticleDescriptionGenerator extends ParticleDescriptionProvider {
    ...
    protected void addDescriptions() {
        this.spriteSet(ModParticles.WATER_TAP_DRIP.get(), ResourceLocation.withDefaultNamespace("drip_hang"));
        this.spriteSet(ModParticles.LAVA_TAP_DRIP.get(), ResourceLocation.withDefaultNamespace("drip_hang"));
        ...
        this.spriteSet(ModParticles.LEGACY_SAKURA_INCENSE_PARTICLE.get(), KaleidoscopeTavern.modLoc("sakura"));
        this.spriteSet(ModParticles.LEGACY_PINE_INCENSE_PARTICLE.get(), KaleidoscopeTavern.modLoc("pine"));
        this.spriteSet(ModParticles.LEGACY_GINKGO_INCENSE_PARTICLE.get(), KaleidoscopeTavern.modLoc("ginkgo"));
        this.spriteSet(ModParticles.LEGACY_SPORE_INCENSE_PARTICLE.get(), KaleidoscopeTavern.modLoc("spore"));
        this.spriteSet(ModParticles.LEGACY_CATNIP_INCENSE_PARTICLE.get(), KaleidoscopeTavern.modLoc("catnip"));
        this.spriteSet(ModParticles.LEGACY_SNOW_INCENSE_PARTICLE.get(), KaleidoscopeTavern.modLoc("snow_incense"));
        this.spriteSet(ModParticles.LEGACY_BUTTERFLY_INCENSE_PARTICLE.get(), KaleidoscopeTavern.modLoc("butterfly"));
        this.spriteSet(ModParticles.LEGACY_FIREFLY_INCENSE_PARTICLE.get(), KaleidoscopeTavern.modLoc("firefly"));

        this.spriteSet(ModParticles.LEGACY_PINE_INCENSE_LARGE_PARTICLE.get(),
                KaleidoscopeTavern.modLoc("pine_large/1"),
                KaleidoscopeTavern.modLoc("pine_large/2"),
                KaleidoscopeTavern.modLoc("pine_large/3")
        );
        this.spriteSet(ModParticles.LEGACY_GINKGO_INCENSE_LARGE_PARTICLE.get(), KaleidoscopeTavern.modLoc("ginkgo_large"));
        this.spriteSet(ModParticles.LEGACY_CATNIP_INCENSE_LARGE_PARTICLE.get(), KaleidoscopeTavern.modLoc("catnip_large"));
        this.spriteSet(ModParticles.LEGACY_SNOW_INCENSE_LARGE_PARTICLE.get(),
                KaleidoscopeTavern.modLoc("snow_incense_large/1"),
                KaleidoscopeTavern.modLoc("snow_incense_large/2")
        );
        this.spriteSet(ModParticles.LEGACY_BUTTERFLY_INCENSE_LARGE_PARTICLE.get(),
                KaleidoscopeTavern.modLoc("butterfly_large/1"),
                KaleidoscopeTavern.modLoc("butterfly_large/2"),
                KaleidoscopeTavern.modLoc("butterfly_large/3")
        );
        this.spriteSet(ModParticles.LEGACY_FIREFLY_INCENSE_LARGE_PARTICLE.get(), KaleidoscopeTavern.modLoc("firefly_large"));
    }
}
