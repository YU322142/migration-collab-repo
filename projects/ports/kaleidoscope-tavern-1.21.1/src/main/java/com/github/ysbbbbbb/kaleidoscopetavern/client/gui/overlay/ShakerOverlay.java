...
public class ShakerOverlay implements LayeredDraw.Layer {
    private static final ResourceLocation IMG = KaleidoscopeTavern.modLoc("textures/gui/shaker.png");
    private static final ResourceLocation ICON = KaleidoscopeTavern.modLoc("gui/rhombus");
