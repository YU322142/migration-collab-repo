...
public class ShapelessRecipeProvider extends ModRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, ModItems.NIGHT_EPIPHANY_PAINTING.get())
                .requires(Items.ITEM_FRAME)
    ...
    private void saveBackportedBoardRecipe(RecipeOutput consumer, String itemName, String recipeName) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, ModItems.EYEBLOSSOM_SANDWICH_BOARD.get())
                .requires(ModItems.BASE_SANDWICH_BOARD.get())
                .requires(ModBlocks.backportedItem(itemName))
                .unlockedBy("has_base_sandwich_board", has(ModItems.BASE_SANDWICH_BOARD.get()))
                .save(consumer, KaleidoscopeTavern.modLoc(recipeName));
    }
