...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> BLOCK_TEAPOT_PROCESSING = registerSound("block.teapot.processing");
    public static final RegistryObject<SoundEvent> TRASH_CAN = registerSound("block.trash_can");
