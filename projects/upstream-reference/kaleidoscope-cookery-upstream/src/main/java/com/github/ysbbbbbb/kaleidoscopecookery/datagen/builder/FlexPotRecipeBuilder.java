...
public class FlexPotRecipeBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> recipeOutput, ResourceLocation id) {
        recipeOutput.accept(new FlexPotFinishedRecipe(id, this.time, this.stirFryCount, this.carrier, this.ingredients, this.result));
    }

    public static class FlexPotFinishedRecipe implements FinishedRecipe {
        ...
        public FlexPotFinishedRecipe(ResourceLocation id, int time, int stirFryCount, Ingredient carrier, List<Ingredient> ingredients, ItemStack result) {
            this.id = id;
            this.time = time;
            this.stirFryCount = stirFryCount;
