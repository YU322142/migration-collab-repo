...
public class FlexPotRecipeCategory implements IRecipeCategory<FlexPotRecipe> {
    public static final RecipeType<FlexPotRecipe> TYPE = RecipeType.create(KaleidoscopeCookery.MOD_ID, "flex_pot", FlexPotRecipe.class);
    ...
    public static List<FlexPotRecipe> getRecipes() {
        ClientLevel level = Minecraft.getInstance().level;
        if (level == null) {
            return List.of();
        }
        List<FlexPotRecipe> potRecipes = Lists.newArrayList();
        potRecipes.addAll(level.getRecipeManager().getAllRecipesFor(ModRecipes.FLEX_POT_RECIPE));
        return potRecipes;
    }

    @Override
    public void draw(FlexPotRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    @Override
    public void createRecipeExtras(IRecipeExtrasBuilder builder, FlexPotRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, FlexPotRecipe recipe, IFocusGroup focuses) {
        NonNullList<Ingredient> inputs = recipe.getIngredients();
    ...
    @Override
    public RecipeType<FlexPotRecipe> getRecipeType() {
        return TYPE;
    }
